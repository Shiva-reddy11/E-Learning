...
const StudentsReviews3 = () => {
  ...
  useEffect(() => {
    ...
    const handlePreviousClick = () => keenSlider.prev();
    const handleNextClick = () => keenSlider.next();

    keenSliderPrevious.addEventListener('click', handlePreviousClick);
    keenSliderNext.addEventListener('click', handleNextClick);

    // Cleanup function
    return () => {
      keenSlider.destroy();
      keenSliderPrevious.removeEventListener('click', handlePreviousClick);
      keenSliderNext.removeEventListener('click', handleNextClick);
    };
  }, []);
...
export default StudentsReviews3;
